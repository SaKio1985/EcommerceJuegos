...
const CartComponent = () => {
	...
	const handleBuy = () => {
		...
		alert(
			"¡Gracias por tu compra! Estás siendo redirigido a la pasarela de pago...",
		);
		...
		return (
			<div className="cart-container">
				<div className="empty-cart">
					...
					<p>
						¡Descubre nuestros increíbles juegos de mesa y añade algunos a tu
						carrito!
					</p>
			...
			<div className="cart-content">
							...
							<div className="cart-item-info">
								...
								<div className="cart-item-controls">
									<div className="quantity-control">
										<button
											onClick={() =>
												actualizarProducto(item.id, item.quantity - 1)
											}
				...
				<div className="cart-summary">
					...
					<div className="summary-row">
						<span>Total:</span>
						<span>
							{(carroTotal() + (carroTotal() >= 30 ? 0 : 4.95)).toFixed(2)}€
						</span>
					</div>
