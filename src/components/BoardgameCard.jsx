...
export default function BoardgameCard({ boardgame, customClass, minimal }) {
	...
	let availabilityMessage = availability;
	if (availability === "Prelanzamiento" && releaseDate) {
		availabilityMessage = `Prelanzamiento - ${releaseDate}`;
	}
			...
			<div className="card-content">
				...
				{!minimal && (
					<>
						...
						<p className="card-availability">{availabilityMessage}</p>
